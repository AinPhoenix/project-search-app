...
export type CordProduct = Omit<Product, "createdAt" | "updatedAt">;

const index = new Index<CordProduct>();
...
const page = async ({ searchParams }: PageProps) => {
  ...
  let products: CordProduct[] = await db
    .select()
    .from(productsTable)
    .where(
  ...
  if (products.length === 0)
    return (
      <div className="text-center py-4 bg-white shadow-sm rounded-b-md">
        ...
        <p className="mt-1 text-sm mx-auto">
